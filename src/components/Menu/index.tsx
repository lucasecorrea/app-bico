			...
			<View style={tw`flex-1 px-5 justify-center`}>
				<View style={tw`flex-row items-center h-10`}>
					<TouchableOpacity style={tw`flex-1 rounded-lg h-11 justify-center items-center`}
						...
						<Image style={tw`rounded h-5 w-5`} source={require('D:/Projetos/app-bico/src/images/menu.png')} />
					...
					<TouchableOpacity style={tw`flex-1 rounded-lg h-11 justify-center items-center`}
						...
						<Image style={tw`rounded h-5 w-5`} source={require('D:/Projetos/app-bico/src/images/add.png')} />
