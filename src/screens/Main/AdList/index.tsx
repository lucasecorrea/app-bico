				...
				<ScrollView style={tw`flex-1`}>
					<View style={tw`flex-row pl-[75%] top-15 items-center`}>
						<TouchableOpacity style={tw`flex-row justify-center items-center bg-red-700`}
							...
							<Image style={tw`rounded h-8 w-8`} source = {require('D:/Projetos/app-bico/src/images/logout.png')} />
						</TouchableOpacity>
					</View>
						...
						<View style={tw`flex-1 px-5 pt-4 justify-center`}>
							<View style={tw`flex-row items-center h-10 `}>
								<TouchableOpacity style={tw`flex-1 flex-row rounded-lg h-11 justify-center items-center`}
									onPress={() => null}>
									<Image style={tw`rounded h-5 w-5`} source = {require('D:/Projetos/app-bico/src/images/pesquisar.png')} />
									<Text style={tw`pl-3`}>Pesquisar</Text>
								</TouchableOpacity>
								<TouchableOpacity style={tw`flex-1 flex-row rounded-lg h-11 justify-center items-center`}
									onPress={() => null}>
									<Image style={tw`rounded h-5 w-5`} source = {require('D:/Projetos/app-bico/src/images/ordenar.png')} />
